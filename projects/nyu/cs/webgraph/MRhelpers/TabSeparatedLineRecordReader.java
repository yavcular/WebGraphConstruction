 ...
 */
public class TabSeparatedLineRecordReader extends RecordReader<Text, Text> {
	...
	private static final Log LOG = LogFactory.getLog(TabSeparatedLineRecordReader.class);
		...
		if (pos < end) {
			...
			if (newSize != 0) {
				...
				if (currentline.contains("\t"))
				{
					...
					key.set(currentline.substring(0, tabPos));
					value.set(currentline.substring(tabPos + 1));
				}
				else
				{
					key.set(line);
