...
$H_DIR/bin/hadoop fs -rmr $WG_OUT_DIR/analysis-locality-phase2
$H_DIR/bin/hadoop jar $H_DIR/g.jar nyu/cs/webgraph/analysis/AnalyseOutlinkLocalityPhase2 $1 $WG_OUT_DIR/analysis-locality-phase2
