...
$H_DIR/bin/hadoop fs -rmr $WG_OUT_DIR/analysis-added-removed-links
$H_DIR/bin/hadoop jar $H_DIR/g.jar nyu/cs/webgraph/analysis/AnalyseUpdatedLinkLists $1 $2 $WG_OUT_DIR/analysis-added-removed-links
